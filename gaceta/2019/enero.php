<?php
	...
	$con_sesiones="SELECT * FROM calendario_gaceta cg JOIN comision_gaceta cmg ON cg.titulo_evento = cmg.id_comision JOIN sesion_comision sc ON sc.codigo_evento = cg.codigo_evento WHERE cg.fecha_evento BETWEEN '2019-01-01' AND '2019-01-31' ORDER BY cg.fecha_evento DESC";
