        ...
        <section class="solid_banner_area">
            <div class="container">
                <div class="solid_banner_inner">
                    <h1>Direcciones Centralizadas</h1>
                    <ul>
						<li>Usted se encuentra en:</li>
                        <li><a href="index.php">Inicio</a></li>
						<li><a href="">Gobierno</a></li>
                        <li><a href="centralizadas.php"><strong>Centralizadas</strong></a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="contact_area p_100">
            <div class="container mt-40">
				<div class="row mt-30">
					<?php
						$nums=1;
						$query=mysqli_query($con,"SELECT * FROM users u, dependencias d WHERE u.id_dep=d.id_dep AND d.nivel='2' ORDER BY d.name ASC");
						while($row=mysqli_fetch_array($query)){
					?>
					<div class="col-lg-4 col-md-4 col-xs-6" style="margin-bottom:20px;">
						<div class="box16">
