            ...
            <div class="container">
                <div class="solid_banner_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="h-ayuntamiento.php"><strong>H. Ayuntamiento</strong></a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="contact_area p_100">
            <div class="container mt-40">
				<div class="row mt-30">
					<?php
						$nums=1;
						$query=mysqli_query($con,"SELECT * FROM users u, dependencias d WHERE u.id_dep=d.id_dep AND d.nivel='1' ORDER BY u.user_id  ASC");
