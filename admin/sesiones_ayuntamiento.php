				...
				<div class="panel-heading">
					<div class="btn-group pull-right">
						<a href="nueva_sesion_ayuntamiento.php" class="btn btn-info" >
							<span class="glyphicon glyphicon-plus" ></span> Nueva Sesi&oacute;n Ayuntamiento
						</a>
					</div>
					<h4><i class='glyphicon glyphicon-search'></i> Buscar Sesiones de Ayuntamiento</h4>
				</div>			
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="datos_cotizacion">
						<div class="form-group row">
							<label for="q" class="col-md-2 control-label">Sesiones de Ayuntamiento:</label>
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Sesiones de Ayuntamiento" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
