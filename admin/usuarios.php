<?php
	...
	$title="Usuarios | Sistema de Gesti&oacute;n Web";
?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<script>
	...
	$( "#editar_usuario" ).submit(function( event ) {
		...
		$.ajax({
			...
			data: parametros,
			beforeSend: function(objeto){
				$("#resultados_ajax2").html('<img src="./img/ajax-loader.gif">');
			},
			success: function(datos){
	...
	$( "#editar_password" ).submit(function( event ) {
		...
		$.ajax({
			...
			data: parametros,
			beforeSend: function(objeto){
				$("#resultados_ajax3").html('<img src="./img/ajax-loader.gif">');
			},
			success: function(datos){
	...
	function obtener_datos(id){
		...
		var tel1 = $("#tel1"+id).val();
		var tel2 = $("#tel2"+id).val();
		var extencion = $("#extencion"+id).val();
