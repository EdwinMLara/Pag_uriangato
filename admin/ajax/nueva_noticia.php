<?php
	...
	$path = '../images/noticias/'; // upload directory
	$path2 ='images/noticias/';
	if(!empty($_POST['titulo']) || !empty($_POST['descripcion']) || $_FILES['image']){
		...
		if(in_array($ext, $valid_extensions)) { 
			...
			if(move_uploaded_file($tmp,$path)) {
				...
				$sql="INSERT INTO noticias (titulo_noticia, cuerpo_noticia, imagen1, create_at, is_public) VALUES ('$titulo','$descripcion','$path2','$date_added','$estado')";
