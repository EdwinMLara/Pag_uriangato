...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname2'])){
        ...
        } elseif (empty($_POST['tel12'])) {
            $errors[] = "Debe proporcionar un número teléfonico";
        } elseif (
            ...
            $tel1 = mysqli_real_escape_string($con,(strip_tags($_POST["tel12"],ENT_QUOTES)));
            $tel2 = mysqli_real_escape_string($con,(strip_tags($_POST["tel22"],ENT_QUOTES)));
            $extencion = mysqli_real_escape_string($con,(strip_tags($_POST["extencion2"],ENT_QUOTES)));
			$user_id=intval($_POST['mod_id']);
			// write new user's data into database
            $sql = "UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', user_name='".$user_name."', user_email='".$user_email."', tel1='".$tel1."', tel2='".$tel2."', extencion='".$extencion."'
