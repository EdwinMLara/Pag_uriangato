		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="post" id="editar_usuario" name="editar_usuario">
					...
					<div class="form-group">
						<label for="tel12" class="col-sm-3 control-label">Telefono </label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="tel12" name="tel12" placeholder="Telefono" required>
						</div>
					</div>
					<div class="form-group">
						<label for="tel22" class="col-sm-3 control-label">Telefono 2</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="tel22" name="tel22" placeholder="Telefono" required>
						</div>
					</div><div class="form-group">
						<label for="extencion" class="col-sm-3 control-label">Ext.</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="extencion2" name="extencion2" placeholder="Correo Electrónico" required>
						</div>
					</div>
			</div>
