<?php
	...
	$title="Carga de Archivos de Sesi&oacute;n de Comisi&oacute;n | Sistema de Gesti&oacute;n Web";
	$id=$_GET['id'];
?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="container">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="col-md-6">
						<!--
						<form name="MiForm" id="MiForm" method="post" action="cargar_archivos_sesion2.php" enctype="multipart/form-data">
							<div class="form-group">
								<input type="hidden" class="form-control" id="sesion" name="sesion" value="<?php echo $id; ?>">
							</div>
							<div class="form-group">
								<label for="file">Seleccione los Archivos a Cargar</label>
